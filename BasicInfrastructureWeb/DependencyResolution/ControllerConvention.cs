...
namespace BasicInfrastructureWeb.DependencyResolution
{
    public class ControllerConvention : IRegistrationConvention
    {
        ...
        {
            return (type.CanBeCastTo<Controller>() ||
                type.CanBeCastTo<ApiController>()) && !type.IsAbstract;
        }

        public static void Register(IContainer container = null)
        {
            container = container ?? StructuremapMvc.StructureMapDependencyScope.Container;
